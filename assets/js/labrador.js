$(document).ready(function () { 
	$(window).scroll(function (event) {
		...
		// PREDICCION
		if (scroll > 7500) { $('.section-bullets').addClass('section-bullets-black'); }
		if ((scroll >= 7100 && scroll <= 7300) || scroll >= 10000) { $('.section-bullets').removeClass('section-bullets-black'); }
		// LANGUAGE
